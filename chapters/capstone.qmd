...
date: "April 24, 2026"
abstract: |
  Prepared for Dr. Pablo Olivares.
---
...
Then $\Psi(K)=P(N<K)=\sum\limits_{n=0}^{K-1}P(N=n)$. This equation gives the cumulative lower-tail probability of the Poisson-binomial distribution up to one day below the number of days associated with the strike percentage times the expected mean fishable days. It answers the central pricing question: how often would the season fail to reach the minimum acceptable number of fishable days? (Biscarri et al., 2018; Fernandez & Williams, 2010; Hong, 2013). If the strike comes from a percentage of expected fishable days, the model can define $K_s=round(s\mu), \mu=E[N]=\sum\limits_{j=1}^Tp_j$
...
Where $r$ denotes the continuously compounded risk-free rate and $\tau$ denotes the contract length in years. This expected-payoff structure sits at the center of actuarial and burn-analysis pricing for weather-index products (Alaton et al., 2002; Jewson & Brix, 2005; Taib & Benth, 2012; World Bank, 2023).
