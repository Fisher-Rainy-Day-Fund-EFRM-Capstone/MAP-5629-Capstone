---
title: "PART 1: Fishing and Climate Data Analysis & Construction of Fishable Days Index (FDI)"
engine: jupyter
---
...
df_fishing = pd.read_csv(FISHING_PATH, parse_dates=["date"])
...
df_seasonal = (
    ...
    .agg(
        ...
        # days with any lobster trips report
        active_fishing_days = ("n_csl_trips", lambda x: (x > 0).sum()) ed
    )
    .reset_index()
)
...
master_path   = "fdi_master_daily.csv"
seasonal_path = "fdi_seasonal_summary.csv"
